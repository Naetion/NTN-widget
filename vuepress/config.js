...
module.exports = {
  ...
  head: [
    ...
    ['meta', { property: 'og:url', content: 'https://naetion.github.io/NTN-widget' }],
    ['meta', { property: 'og:image', content: 'https://naetion.github.io/NTN-widget/assets/images/watch-token.png' }], // eslint-disable-line max-len
    ['meta', { property: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { property: 'twitter:image', content: 'https://naetion.github.io/NTN-widget/assets/images/watch-token.png' }], // eslint-disable-line max-len
